...
func TestBlake3CompleteReadReportsTruncatedInput(t *testing.T) {
	if _,err:=blake3CompleteRead(bytes.NewBufferString("ab"),4); err==nil { t.Fatal("expected short read error") }
}
